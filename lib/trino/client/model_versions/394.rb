...
module Trino::Client::ModelVersions
  ...
  module V394
    ...
    class << AnalyzeTableHandle =
        Base.new(:catalog_handle, :transaction_handle, :connector_handle)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << BasicQueryStats =
        Base.new(:create_time, :end_time, :queued_time, :elapsed_time, :execution_time, :failed_tasks, :total_drivers, :queued_drivers, :running_drivers, :completed_drivers, :raw_input_data_size, :raw_input_positions, :physical_input_data_size, :cumulative_user_memory, :failed_cumulative_user_memory, :user_memory_reservation, :total_memory_reservation, :peak_user_memory_reservation, :peak_total_memory_reservation, :total_cpu_time, :failed_cpu_time, :total_scheduled_time, :failed_scheduled_time, :fully_blocked, :blocked_reasons, :progress_percentage)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << CatalogProperties =
        Base.new(:catalog_handle, :connector_name, :properties)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << CreateTarget =
        Base.new(:handle, :schema_table_name, :reporting_written_bytes_supported)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
        ...
        obj.send(:initialize_struct,
          ...
          hash["reportingWrittenBytesSupported"],
        )
        obj
      end
    end
    ...
    class << DriverStats =
        Base.new(:create_time, :start_time, :end_time, :queued_time, :elapsed_time, :user_memory_reservation, :revocable_memory_reservation, :total_scheduled_time, :total_cpu_time, :total_blocked_time, :fully_blocked, :blocked_reasons, :physical_input_data_size, :physical_input_positions, :physical_input_read_time, :internal_network_input_data_size, :internal_network_input_positions, :raw_input_data_size, :raw_input_positions, :raw_input_read_time, :processed_input_data_size, :processed_input_positions, :input_blocked_time, :output_data_size, :output_positions, :output_blocked_time, :physical_written_data_size, :operator_stats)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << JoinNode =
        Base.new(:id, :type, :left, :right, :criteria, :left_output_symbols, :right_output_symbols, :may_skip_output_duplicates, :filter, :left_hash_symbol, :right_hash_symbol, :distribution_type, :spillable, :dynamic_filters, :reorder_join_stats_and_cost)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << LimitNode =
        Base.new(:id, :source, :count, :ties_resolving_scheme, :partial, :requires_pre_sorted_inputs)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << MergeHandle =
        Base.new(:table_handle, :connector_merge_handle)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << MergeParadigmAndTypes =
        Base.new(:paradigm, :column_types, :row_id_type)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << MergeTarget =
        Base.new(:handle, :merge_handle, :schema_table_name, :merge_paradigm_and_types)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
        ...
        obj.send(:initialize_struct,
          hash["handle"] && TableHandle.decode(hash["handle"]),
          hash["mergeHandle"] && MergeHandle.decode(hash["mergeHandle"]),
          hash["schemaTableName"] && SchemaTableName.decode(hash["schemaTableName"]),
        )
        obj
      end
    ...
    class << Output =
        Base.new(:catalog_name, :schema, :table, :columns)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << OutputTableHandle =
        Base.new(:catalog_handle, :table_name, :transaction_handle, :connector_handle)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
        obj = allocate
        obj.send(:initialize_struct,
          hash["tableName"] && SchemaTableName.decode(hash["tableName"]),
          hash["transactionHandle"],
          hash["connectorHandle"],
        )
        obj
    ...
    class << PipelineStats =
        Base.new(:pipeline_id, :first_start_time, :last_start_time, :last_end_time, :input_pipeline, :output_pipeline, :total_drivers, :queued_drivers, :queued_partitioned_drivers, :queued_partitioned_splits_weight, :running_drivers, :running_partitioned_drivers, :running_partitioned_splits_weight, :blocked_drivers, :completed_drivers, :user_memory_reservation, :revocable_memory_reservation, :queued_time, :elapsed_time, :total_scheduled_time, :total_cpu_time, :total_blocked_time, :fully_blocked, :blocked_reasons, :physical_input_data_size, :physical_input_positions, :physical_input_read_time, :internal_network_input_data_size, :internal_network_input_positions, :raw_input_data_size, :raw_input_positions, :processed_input_data_size, :processed_input_positions, :input_blocked_time, :output_data_size, :output_positions, :output_blocked_time, :physical_written_data_size, :operator_summaries, :drivers)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
        ...
        obj.send(:initialize_struct,
          ...
          hash["queuedPartitionedSplitsWeight"],
          hash["runningDrivers"],
          hash["runningPartitionedDrivers"],
          hash["runningPartitionedSplitsWeight"],
          hash["blockedDrivers"],
          hash["completedDrivers"],
          hash["userMemoryReservation"],
          hash["revocableMemoryReservation"],
    ...
    class << PlanFragment =
        Base.new(:id, :root, :symbols, :partitioning, :partitioned_sources, :partitioning_scheme, :stats_and_costs, :active_catalogs, :json_representation)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
        ...
        obj.send(:initialize_struct,
          ...
          hash["activeCatalogs"] && hash["activeCatalogs"].map {|h| CatalogProperties.decode(h) },
    ...
    class << QueryStats =
      ...
      def decode(hash)
        ...
        obj.send(:initialize_struct,
          ...
          hash["rawInputDataSize"],
          hash["failedRawInputDataSize"],
          hash["rawInputPositions"],
          hash["failedRawInputPositions"],
          hash["processedInputDataSize"],
    ...
    class << RemoteSourceNode =
        Base.new(:id, :source_fragment_ids, :outputs, :ordering_scheme, :exchange_type, :retry_policy)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << ResolvedFunction =
        Base.new(:signature, :id, :function_kind, :deterministic, :nullability, :type_dependencies, :function_dependencies)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
        ...
        obj.send(:initialize_struct,
          ...
          hash["deterministic"],
          hash["nullability"] && FunctionNullability.decode(hash["nullability"]),
    ...
    class << SessionRepresentation =
        Base.new(:query_id, :transaction_id, :client_transaction_support, :user, :groups, :principal, :enabled_roles, :source, :catalog, :schema, :path, :trace_token, :time_zone_key, :locale, :remote_user_address, :user_agent, :client_info, :client_tags, :client_capabilities, :resource_estimates, :start, :system_properties, :catalog_properties, :catalog_roles, :prepared_statements, :protocol_name)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << SplitOperatorInfo =
        Base.new(:catalog_handle, :split_info)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << StageStats =
        Base.new(:scheduling_complete, :get_split_distribution, :total_tasks, :running_tasks, :completed_tasks, :failed_tasks, :total_drivers, :queued_drivers, :running_drivers, :blocked_drivers, :completed_drivers, :cumulative_user_memory, :failed_cumulative_user_memory, :user_memory_reservation, :revocable_memory_reservation, :total_memory_reservation, :peak_user_memory_reservation, :peak_revocable_memory_reservation, :total_scheduled_time, :failed_scheduled_time, :total_cpu_time, :failed_cpu_time, :total_blocked_time, :fully_blocked, :blocked_reasons, :physical_input_data_size, :failed_physical_input_data_size, :physical_input_positions, :failed_physical_input_positions, :physical_input_read_time, :failed_physical_input_read_time, :internal_network_input_data_size, :failed_internal_network_input_data_size, :internal_network_input_positions, :failed_internal_network_input_positions, :raw_input_data_size, :failed_raw_input_data_size, :raw_input_positions, :failed_raw_input_positions, :processed_input_data_size, :failed_processed_input_data_size, :processed_input_positions, :failed_processed_input_positions, :input_blocked_time, :failed_input_blocked_time, :buffered_data_size, :output_data_size, :failed_output_data_size, :output_positions, :failed_output_positions, :output_blocked_time, :failed_output_blocked_time, :physical_written_data_size, :failed_physical_written_data_size, :gc_info, :operator_summaries)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << TableExecuteTarget =
        Base.new(:execute_handle, :source_handle, :schema_table_name, :reporting_written_bytes_supported)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
        obj = allocate
        obj.send(:initialize_struct,
          hash["executeHandle"] && TableExecuteHandle.decode(hash["executeHandle"]),
          hash["sourceHandle"] && TableHandle.decode(hash["sourceHandle"]),
          hash["schemaTableName"] && SchemaTableName.decode(hash["schemaTableName"]),
          hash["reportingWrittenBytesSupported"],
        )
        obj
    ...
    class << TableHandle =
        Base.new(:catalog_handle, :connector_handle, :transaction)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << TableInfo =
        Base.new(:connector_name, :table_name, :predicate)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << TableScanNode =
        Base.new(:id, :table, :output_symbols, :assignments, :update_target, :use_connector_node_partitioning)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
        ...
        obj.send(:initialize_struct,
          ...
          hash["assignments"],
          hash["updateTarget"],
          hash["useConnectorNodePartitioning"],
        )
        obj
      end
    end
    ...
    class << TableWriterNode =
        Base.new(:id, :source, :target, :row_count_symbol, :fragment_symbol, :columns, :column_names, :partitioning_scheme, :preferred_partitioning_scheme, :statistics_aggregation, :statistics_aggregation_descriptor)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
        ...
        obj.send(:initialize_struct,
          ...
          hash["columnNames"],
          hash["partitioningScheme"] && PartitioningScheme.decode(hash["partitioningScheme"]),
          hash["preferredPartitioningScheme"] && PartitioningScheme.decode(hash["preferredPartitioningScheme"]),
          hash["statisticsAggregation"] && StatisticAggregations.decode(hash["statisticsAggregation"]),
          hash["statisticsAggregationDescriptor"] && StatisticAggregationsDescriptor_Symbol.decode(hash["statisticsAggregationDescriptor"]),
        )
        obj
    ...
    class << TaskInfo =
        Base.new(:task_status, :last_heartbeat, :output_buffers, :no_more_splits, :stats, :estimated_memory, :needs_plan)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << TaskStats =
        Base.new(:create_time, :first_start_time, :last_start_time, :last_end_time, :end_time, :elapsed_time, :queued_time, :total_drivers, :queued_drivers, :queued_partitioned_drivers, :queued_partitioned_splits_weight, :running_drivers, :running_partitioned_drivers, :running_partitioned_splits_weight, :blocked_drivers, :completed_drivers, :cumulative_user_memory, :user_memory_reservation, :peak_user_memory_reservation, :revocable_memory_reservation, :total_scheduled_time, :total_cpu_time, :total_blocked_time, :fully_blocked, :blocked_reasons, :physical_input_data_size, :physical_input_positions, :physical_input_read_time, :internal_network_input_data_size, :internal_network_input_positions, :raw_input_data_size, :raw_input_positions, :processed_input_data_size, :processed_input_positions, :input_blocked_time, :output_data_size, :output_positions, :output_blocked_time, :physical_written_data_size, :full_gc_count, :full_gc_time, :pipelines)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << TaskStatus =
        Base.new(:task_id, :task_instance_id, :version, :state, :self, :node_id, :failures, :queued_partitioned_drivers, :running_partitioned_drivers, :output_buffer_overutilized, :physical_written_data_size, :memory_reservation, :peak_memory_reservation, :revocable_memory_reservation, :full_gc_count, :full_gc_time, :dynamic_filters_version, :queued_partitioned_splits_weight, :running_partitioned_splits_weight)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << UpdateTarget =
        Base.new(:handle, :schema_table_name, :updated_columns, :updated_column_handles)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
